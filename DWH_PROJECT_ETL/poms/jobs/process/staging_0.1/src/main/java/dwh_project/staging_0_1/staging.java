...
package dwh_project.staging_0_1;
 ...
 * @status
 */
public class staging implements TalendJob {
	...
	private final String jobName = "staging";
	private final String projectName = "DWH_PROJECT";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(staging.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class DimCustomerStruct implements routines.system.IPersistableRow<DimCustomerStruct> {
		final static byte[] commonByteArrayLock_DWH_PROJECT_staging = new byte[0];
		static byte[] commonByteArray_DWH_PROJECT_staging = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_DWH_PROJECT_staging.length) {
					if (length < 1024 && commonByteArray_DWH_PROJECT_staging.length == 0) {
						commonByteArray_DWH_PROJECT_staging = new byte[1024];
					} else {
						commonByteArray_DWH_PROJECT_staging = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_DWH_PROJECT_staging, 0, length);
				strReturn = new String(commonByteArray_DWH_PROJECT_staging, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_DWH_PROJECT_staging, 0, length);
				strReturn = new String(commonByteArray_DWH_PROJECT_staging, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_DWH_PROJECT_staging) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:A0/UQPT8QucjW2iYqjdjmmc7IkGJsl458rRMaYCFC5k8ITka");
...
// ###############################
				...
				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jvh+tPbpQhSkakj0QoIXsWuGIKIlnUiK3yZQudmOjqL3jR9V");
				...
				String dbquery_tDBInput_1 = "SELECT dbo.customer.customer_id,\n		dbo.customer.first_name,\n		dbo.customer.last_name,\n		dbo.customer.age,\n		dbo.custome"
						+ "r.gender,\n		dbo.customer.city,\n		dbo.customer.no_hp\nFROM	dbo.customer";
...
// Start of branch "DimCustomer"
						if (DimCustomer != null) {
							...
							pstmt_tDBOutput_1.setInt(1, DimCustomer.CustomerID);

							if (DimCustomer.CustomerName == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, DimCustomer.CustomerName);
							}

							pstmt_tDBOutput_1.setInt(3, DimCustomer.Age);

							if (DimCustomer.Gender == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, DimCustomer.Gender);
							}

							if (DimCustomer.City == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, DimCustomer.City);
							}

							if (DimCustomer.NoHp == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, DimCustomer.NoHp);
							}
...
// ###############################      
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:cp8xf/j8QL73vl+eGGqFf36wxUBPRNmLRfYot5Y/7/SgvW4W");
				...
				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:TG0drYtDO7u3Ftj6hHOhFTBB8RVq9fBbTa6ysSkpzoz5vgjQ");
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 4) {
							row2.ProductUnitPrice = 0;
						} else {

							row2.ProductUnitPrice = rs_tDBInput_2.getInt(4);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						pstmt_tDBOutput_2.setInt(1, row2.ProductID);

						if (row2.ProductName == null) {
							pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(2, row2.ProductName);
						}

						if (row2.ProductCategory == null) {
							pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(3, row2.ProductCategory);
						}

						pstmt_tDBOutput_2.setInt(4, row2.ProductUnitPrice);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:bIPxUBgnw4u/1ZeLQpuG2Z/wGFut2L4Xu3x/Fd4NDXNngfNS");
				...
				final String decryptedPassword_tDBInput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:l+OzuQoBAGviZObq0iulhs4Z03xtxzl4FScHt8v068dUIEKG");
				...
				String dbquery_tDBInput_3 = "SELECT dbo.sales_order.order_id,\n		dbo.sales_order.customer_id,\n		dbo.sales_order.product_id,\n		dbo.sales_order.quantit"
						+ "y,\n		dbo.sales_order.amount,\n		dbo.sales_order.status_id,\n		dbo.sales_order.order_date\nFROM	dbo.sales_order";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 1) {
							...
							row4.OrderID = rs_tDBInput_3.getInt(1);
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							row4.CustomerID = rs_tDBInput_3.getInt(2);
							if (rs_tDBInput_3.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							row4.ProductID = rs_tDBInput_3.getInt(3);
							if (rs_tDBInput_3.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_3 < 4) {
							...
							row4.StatusID = rs_tDBInput_3.getInt(4);
							if (rs_tDBInput_3.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_3 < 5) {
							...
							row4.Quantity = rs_tDBInput_3.getInt(5);
							if (rs_tDBInput_3.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_3 < 6) {
							...
							row4.Amount = rs_tDBInput_3.getInt(6);
							if (rs_tDBInput_3.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_3 < 7) {
							...
							row4.OrderDate = mssqlGTU_tDBInput_3.getDate(rsmd_tDBInput_3, rs_tDBInput_3, 7);
						...
						pstmt_tDBOutput_4.setInt(1, row4.OrderID);

						pstmt_tDBOutput_4.setInt(2, row4.CustomerID);

						pstmt_tDBOutput_4.setInt(3, row4.ProductID);

						pstmt_tDBOutput_4.setInt(4, row4.StatusID);

						pstmt_tDBOutput_4.setInt(5, row4.Quantity);

						pstmt_tDBOutput_4.setInt(6, row4.Amount);

						if (row4.OrderDate != null) {
							pstmt_tDBOutput_4.setTimestamp(7, new java.sql.Timestamp(row4.OrderDate.getTime()));
						} else {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:20T7PcUgGHNa8SscLev81luAQ/zpT2DJeiD51imFlN3P1wg/");
				...
				final String decryptedPassword_tDBInput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:ZI/yA/YfZjxu0Ju2gZGKXkD93nMn7NcxH1txprrOc2tMNIVT");
				...
				String dbquery_tDBInput_4 = "SELECT dbo.status_order.status_id,\n		dbo.status_order.status_order,\n		dbo.status_order.status_order_desc\nFROM	dbo.statu"
						+ "s_order";
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						if (colQtyInRs_tDBInput_4 < 1) {
							...
							row3.StatusID = rs_tDBInput_4.getInt(1);
							if (rs_tDBInput_4.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_4 < 2) {
							row3.StatusOrder = null;
						} else {
							...
							if (tmpContent_tDBInput_4 != null) {
								if (talendToDBList_tDBInput_4.contains(
									...
									row3.StatusOrder = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
								} else {
									row3.StatusOrder = tmpContent_tDBInput_4;
								}
							} else {
								row3.StatusOrder = null;
							}
						...
						if (colQtyInRs_tDBInput_4 < 3) {
							...
							if (tmpContent_tDBInput_4 != null) {
								if (talendToDBList_tDBInput_4.contains(
									...
									row3.StatusOrderDesc = FormatterUtils.formatUnwithE(tmpContent_tDBInput_4);
								} else {
									row3.StatusOrderDesc = tmpContent_tDBInput_4;
								}
							} else {
								row3.StatusOrderDesc = null;
							}
						...
						pstmt_tDBOutput_3.setInt(1, row3.StatusID);

						if (row3.StatusOrder == null) {
							pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_3.setString(2, row3.StatusOrder);
						}

						if (row3.StatusOrderDesc == null) {
							pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_3.setString(3, row3.StatusOrderDesc);
						}
	...
	public static void main(String[] args) {
		final staging stagingClass = new staging();

		int exitCode = stagingClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = staging.class.getClassLoader()
					.getResourceAsStream("dwh_project/staging_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = staging.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : staging");
		}
...
/************************************************************************************************
 * 149495 characters generated by Talend Open Studio for Data Integration on the
 * September 28, 2023, 10:32:38 AM WIB
 ************************************************************************************************/